---
title: "🎥 MortgagesbyDennis Video Engagement System — Executive Summary"
created: 2026-09-07
updated: 2026-09-07
type: process
status: active
source: notion
notion_id: 3ad9e94cf0a4816e9d20df29f7974b91
notion_url: https://app.notion.com/p/3ad9e94cf0a4816e9d20df29f7974b91?pvs=204
tags: [sop, notion-mirror]
sources: [notion: 🎥 MortgagesbyDennis Video Engagement System — Executive Summary]
---

# 🎥 MortgagesbyDennis Video Engagement System — Executive Summary

> Mirrored from Notion page `3ad9e94cf0a4816e9d20df29f7974b91` on 2026-09-07. Source: https://app.notion.com/p/3ad9e94cf0a4816e9d20df29f7974b91?pvs=204
...
90 percent watched
+20
Create priority follow-up recommendation

Completed
+25
Move to highly engaged when fit is sufficient

Replayed
+15
Create high-intent adviser task

CTA clicked
+20
Advance workflow according to CTA

Document opened
+15
Increase product-intent score

Meeting booked
+40
Stop active outreach and move pipeline stage
...
Platform
Primary role
Strategic limitation or advantage

GoHighLevel
General CRM and marketing automation
Useful video communication features, but not deeply integrated prospect-level video intelligence and specialized outcome attribution

Loom
General asynchronous recording
Excellent recording utility, but not a specialized sales-intelligence CRM

Hippo Video
Video creation and sales-engagement infrastructure
Strong SDK and product foundation; commercial embedding rights require validation

Convex CRM Video Sales Agent
Signals, CRM, video, workflows, AI prioritization, and attribution
Proprietary business logic and unified customer outcome system
...
Platform
Primary strength
Convex integration fit
MVP assessment

**Hippo Video**
Embedded sales-video SDK, personalization, reports, webhooks, responses
Strong technically; commercial terms unknown
Future embedded-infrastructure option, subject to pricing and rights

Mux
Developer-first video upload, encoding, playback, and analytics
Excellent
Best pure video infrastructure alternative

Cloudflare Stream
Simple and predictable storage and delivery pricing
Excellent
Best cost-focused infrastructure fallback

Bunny Stream
Low-cost storage and delivery at scale
Good
Useful for later cost optimization

Vidyard
Mature enterprise sales-video workflows
Moderate
Higher cost and greater platform dependence

Sendspark
API-driven personalized prospecting videos at scale
Strong through public API and webhooks
Preferred second-stage scaling platform after campaign validation

**Dubb**
Authentic video messaging, hosted sales pages, CTAs, forms, and engagement tracking
Strong for the pilot through Zapier-to-Convex event transfer
**Recommended immediate operating platform**
...
```mermaid
flowchart TD
    A["MortgagesbyDennis WebsiteAstro / React"] --> B["Hippo Recorder, Player and Personalization SDK"]
    B --> C["Hippo Video InfrastructureProcessing, Hosting, Playback and Reports"]
...
Repeat view
High
Reviewing or sharing information

CTA clicked
Very high
Movement toward action

Video reply or form submission
Very high
Direct engagement

Meeting booked
Conversion event
Qualified sales action
...
interface VideoProvider {
  createRecordingSession(input: RecordingInput): Promise;
  importVideo(input: ImportVideoInput): Promise;
  getVideo(providerVideoId: string): Promise;
  personalizeVideo(input: PersonalizationInput): Promise;
  getVideoReport(providerVideoId: string): Promise;
...
Personalized segment length
Approximate monthly personalized videos from 250 minutes
...
Best role
Direct Convex fit
Approximate useful starting cost
Current assessment

**Dubb + Zapier**
Manual, high-trust one-to-one video selling
Moderate through Zapier/webhooks
About \$62/month
Best low-cost pilot for adviser-recorded videos

**Sendspark Growth**
Automated personalization from a proven base video
**Strong through public API and webhooks**
\$99 monthly or about \$69/month annual equivalent
**Best current API-first MVP option**

Vidyard Video Agent
AI-avatar campaigns and enterprise video operations
Potentially strong, but plan-dependent
Requires commercial confirmation
Strong technical option; broader API is Enterprise-only

Hippo Video
Embedded sales-video SDK and broad engagement features
Strong if commercial API/SDK rights are acceptable
Private proposal required
Functional-fit candidate pending commercial validation
...
interface VideoProvider {
  createRecordingSession?(input: RecordingInput): Promise;
  createPersonalizedVideo(input: PersonalizationInput): Promise;
  getGenerationStatus(jobId: string): Promise;
  getVideo(providerVideoId: string): Promise;
  getVideoReport?(providerVideoId: string): Promise;
  verifyWebhook(rawBody: string, headers: Headers): Promise;
  normalizeEvent(rawEvent: unknown): Promise;
}
```
...
Dubb Pro
Recording, hosting, landing pages, tracking and CTAs
Approximately **\$42/month** with annual billing

Zapier Professional
Dubb-to-Convex event bridge
Approximately **\$20/month** at the entry paid tier

Convex
CRM, scoring, workflows and live dashboard
Potentially **\$0** during the initial pilot

Slack
Notifications and team operating console
Potentially **\$0** during the initial pilot

Estimated base
Excludes email, SMS, enrichment and AI-model costs
Approximately **\$62/month**
...
Form submitted
Immediate notification and task

Meeting booked
Immediate notification and CRM stage update
