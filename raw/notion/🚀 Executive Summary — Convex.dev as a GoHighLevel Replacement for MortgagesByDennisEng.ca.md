---
title: "🚀 Executive Summary — Convex.dev as a GoHighLevel Replacement for MortgagesByDennisEng.ca"
created: 2026-09-07
updated: 2026-09-07
type: process
status: active
source: notion
notion_id: 3ae9e94cf0a481fd90f4fb88f3cb397e
notion_url: https://app.notion.com/p/3ae9e94cf0a481fd90f4fb88f3cb397e?pvs=204
tags: [sop, notion-mirror]
sources: [notion: 🚀 Executive Summary — Convex.dev as a GoHighLevel Replacement for MortgagesByDennisEng.ca]
---

# 🚀 Executive Summary — Convex.dev as a GoHighLevel Replacement for MortgagesByDennisEng.ca

> Mirrored from Notion page `3ae9e94cf0a481fd90f4fb88f3cb397e` on 2026-09-07. Source: https://app.notion.com/p/3ae9e94cf0a481fd90f4fb88f3cb397e?pvs=204
...
GoHighLevel Function
Convex-Based Replacement
MVP Priority

Contact CRM
Contacts, companies, households, tags, notes, custom fields, and consent records
Essential

Opportunity pipelines
Mortgage pipelines, stages, values, probabilities, assignments, and stage history
Essential

Forms and surveys
Astro or React forms connected to Convex HTTP functions and mutations
Essential

Workflow automation
Event triggers, conditions, actions, scheduled functions, approvals, retries, and logs
Essential

Email and SMS
Convex orchestration with Resend and Twilio
Essential

Unified conversations
Convex message timeline with Unipile for Gmail, LinkedIn, and WhatsApp
High

Calendar and appointments
Connected calendar availability, booking records, reminders, and rescheduling workflows
High

Campaign sequences
Audiences, steps, templates, delays, sending windows, reply detection, and suppression
High

Dashboards and reporting
Real-time Convex dashboards for leads, activities, pipeline, appointments, and conversions
High

AI tools
Qualification, prioritization, summaries, content drafting, and next-best-action agents
Differentiator

Membership and billing
Clerk organizations and Stripe subscriptions for future multi-tenant use
Later MVP

# Proposed Technology Architecture
```mermaid
flowchart TB
A["MortgagesByDennisEng.caAstro SEO website"] --> B["Lead forms, calculators, assessments, booking"]
B --> C["Convex backend"]
...
Building too many GHL features before launch
Prioritize only workflows required to acquire, qualify, nurture, and convert mortgage leads.

Agent actions create incorrect communications or CRM changes
Use approval gates, permission scopes, test tenants, audit logs, and reversible actions.

Duplicate sends or workflow executions
Use idempotency keys, transactional mutations, workflow execution records, and retry policies.

Tenant or customer data exposure
Enforce tenant isolation in every query and mutation, with centralized authorization helpers.

Communication compliance failures
Store consent evidence, suppression state, channel permissions, sending windows, and delivery history.

Provider dependency
Use integration adapters so Resend, Twilio, Unipile, calendar, or AI providers can be changed.

Development agents access production
Give each agent an isolated temporary deployment and deployment-scoped credentials.
...
Verticals
Defines the market, geography, regulatory context, primary entity type, and module settings.

Vertical field definitions
Adds configurable industry-specific fields without placing mortgage logic inside core CRM tables.

ICP profiles
Defines target segments, fit criteria, exclusions, geography, revenue, roles, and attributes.

Personas
Stores pains, desired outcomes, objections, triggers, decision roles, and preferred channels.

Offers
Defines assessments, consultations, services, lead magnets, financing products, proof, and calls to action.

GTM skills
Stores reusable skill triggers, procedures, inputs, outputs, tools, permissions, versions, and execution policies.

Vertical skill installations
Configures a shared skill for a specific vertical, including model settings, instructions, and approval gates.

Signals
Captures observed buyer, account, engagement, market, referral, and readiness events.

Scoring models
Separates fit, intent, engagement, readiness, urgency, relationship, and expected-value scoring.

GTM playbooks
Combines skills, actions, conditions, approvals, branches, and exit criteria into repeatable motions.

Campaigns and members
Executes playbooks against defined audiences and tracks progression, next actions, exits, and suppression.

Agent runs and approvals
Provides traceability for inputs, outputs, models, tool calls, validation, approval, errors, and completion.

Attribution and outcomes
Connects signals, skills, campaigns, opportunities, funded results, revenue, and cost.
...
```mermaid
flowchart LR
A["Vertical GTM strategyICP, persona, offer, playbook"] --> B["GTM engineering router"]
...
Vertical module
Defines industry-specific market logic
Mortgage renewal ICP, alternative-lending offer, referral-partner persona, compliance policy

GTM strategy skills
Designs the growth motion
ICP creation, positioning, campaign plan, messaging, SEO, AEO, account-based strategy

GTM engineering skills
Produces and validates operational GTM data
TAM building, enrichment, LinkedIn resolution, niche-signal discovery, portfolio prospecting

Convex platform
Stores state and orchestrates workflows
Contacts, accounts, signals, scores, agent runs, approvals, campaigns, opportunities, attribution

Channel providers
Deliver approved communications
Resend, Twilio, Unipile, Gmail, LinkedIn, WhatsApp

## Repository Skills to Incorporate

Skill
Platform role
Mortgage vertical application

`deepline-gtm`
Meta-router for provider-driven GTM tasks
Choose the appropriate sourcing, enrichment, validation, and export workflow for a campaign

`build-tam`
Build target account and contact universes from ICP filters
Create lists of accountants, realtors, financial planners, builders, property managers, or employers by region

`portfolio-prospecting`
Find organizations associated with an investor, accelerator, network, or portfolio
Identify real-estate developers, construction firms, housing groups, and investment networks with financing needs

`linkedin-url-lookup`
Resolve and validate professional profile identity
Match referral partners and commercial-financing decision-makers to the correct LinkedIn profile

`niche-signal-discovery`
Compare won and lost accounts to discover predictive signals
Identify characteristics that distinguish booked, applied, approved, funded, lost, or inactive mortgage opportunities

`clay-to-deepline`
Convert spreadsheet enrichment logic into code-based workflows
Migrate existing Clay or spreadsheet enrichment processes into repeatable agent workflows

`workflow-hello-world`
Scaffold scheduled or webhook-triggered workflows
Run recurring referral-partner discovery, lead enrichment, renewal monitoring, or database hygiene processes
...
Platform
Primary role
Contribution to GHL replacement

Convex
System of record, workflow orchestration, scoring, permissions, campaign state, analytics, and attribution
Replaces CRM, workflow, pipeline, campaign logic, automation history, and reporting

Happenstance
Natural-language people search, network intelligence, relevant-person discovery, and warm-path identification
Adds relationship-led prospect discovery beyond ordinary contact lists

Unipile
LinkedIn profile resolution, relationship state, connected-account messaging, replies, invitations, and conversation events
Replaces LinkedIn engagement and unified-conversation functions

Deepline
Email, telephone, company, and person enrichment through provider waterfalls, validation, and cost routing
Replaces Clay-style enrichment and data waterfall operations

GTM Skills and GTM Engineering Skills
Reusable strategy, research, enrichment, campaign, RevOps, and execution workflows
Provides agent-operable playbooks instead of static automation templates

Resend, Twilio, and connected channels
Email, SMS, voice, and notification delivery
Replaces outbound delivery functions
...
Traditional GHL marketing function
Convex GTM replacement

Static contact lists
ICP-driven network discovery and enriched relationship candidates

Generic lead scoring
Fit, intent, engagement, readiness, relationship, and strategic-value scoring

Basic campaign sequences
Vertical playbooks with channel selection, approval gates, and next-best-action logic

LinkedIn handled outside the CRM
Unipile-connected LinkedIn identity, conversations, invitations, and events inside Convex

Third-party list enrichment
Deepline provider waterfalls with provenance, validation, and budget controls

Cold-first prospecting
Warm-path-first prospecting through Happenstance and relationship scoring

Activity reporting
End-to-end attribution from network source and introduction path to referral and funded mortgage
...
Platform
Role in the GTM vertical

Convex
System of record, CRM, properties, mandates, transactions, workflows, scoring, approvals, attribution, and reporting.

Happenstance
Relationship-led discovery of buyers, investors, developers, lenders, brokers, and warm introduction paths.

Unipile
LinkedIn identity verification, unified one-to-one messaging, relationship events, and conversation synchronization.

Deepline
Company, owner, decision-maker, work-email, phone, and firmographic enrichment through provider waterfalls.

Smartlead
Approved B2B cold-email campaign execution, sending-account rotation, deliverability controls, reply events, and campaign analytics.

GTM Skills
Reusable market, ICP, positioning, prospecting, outreach, RevOps, SEO, AEO, and campaign playbooks.

GTM Engineering Skills
Repeatable enrichment, list building, signal discovery, data workflows, and programmatic GTM execution.
...
Whatcom Building Systems FDI Thesis — Evidence-Backed Executive Summary