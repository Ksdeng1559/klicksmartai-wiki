...
||-------------|-------------|
|| apex-accelerators | APEX Accelerator (formerly PTAC) — 95 DoD-funded centers providing free SAM.gov registration, bid matching, proposal review, and GIB readiness. $64.9B in contracts assisted (2025). Includes Native American specialist centers. |
|| sbir-sttr | SBIR/STTR intelligence layer — "America's Seed Fund" non-dilutive R&D funding across 14 Critical Technology Areas. Phase I/II/III pipeline. Connects to APEX + RIOS. |
|| grantfunding | GrantFunding intelligence layer — connects county needs, tribal priorities, agency programs, and company capabilities to funding opportunities. Core to GrantFundingAI. |

## Regions & Corridors
| entity-id | Description |
|-----------|-------------|
| cascadia-innovation-corridor | Cross-border BC-WA-OR mega-region; economic profile, trade data, housing crisis (1.4M unit gap), Grand Boulevard strategy, Whatcom MPC investment — 4 source docs filed in research/cascadia/ |

## Tools & Platforms
| entity-id | Description |
|-----------|-------------|
| scotts-directories | Canadian B2B Business Database — largest verified Canadian contacts + companies |
