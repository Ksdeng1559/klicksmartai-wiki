---
title: "Whatcom County, WA — Census & Housing Brief"
...
sources:
  - id: 1
    ...
    url: "https://www.census.gov/quickfacts/fact/table/whatcomcountywashington/PST045224"
  - id: 2
    name: "Data USA — Whatcom County, WA (2024)"
    url: "https://datausa.io/profile/geo/whatcom-county-wa"
  - id: 3
    name: "Whatcom Housing Alliance — Workforce Housing Report (2022)"
    url: "https://whatcomhousingalliance.org/wp-content/uploads/2022/06/Workforce-Housing-Report-Updated-March-2022.pdf"
  - id: 4
...
| Metric | Value | Source |
|--------|-------|--------|
| Population (2025 est.) | **236,392** | `[1]` |
| Population (2020 census) | ~226,852 | `[1]` |
| Growth 2020–2025 | **+4.2%** (+9,540 persons) | `[1]` |
| Growth vs. 2010 | **+14.7%** | `[2]` |
| Persons per household | **2.40** | `[1]` |
| Foreign-born residents | **9.93%** (2024) | `[2]` |
...
| Poverty rate | ~11–12% | `[2]` |
| High school+ (age 25+) | ~91% | `[2]` |
| Bachelor's+ (age 25+) | ~33% | `[2]` |
...
| Metric | Value | Source |
|--------|-------|--------|
| Housing units (2024) | **106,281** | `[1]` |
| Owner-occupied rate | **63.7%** | `[1]` |
| Rental vacancy rate | ~3% (healthy: 5–7%) | `[3]` |
| Owner vacancy rate | ~1% (healthy: 2%) | `[3]` |
| Building permits (2024) | **1,190** | `[1]` |

> Vacancy rates below healthy thresholds signal market distress — no buffer for families in crisis.
...
At standard underwriting (30% gross DTI), median household earning $81,784 can support ~**$385,000** mortgage. Median home sells for $585,800.

| Income Tier | Affordable Home Price | Median Home Price | Gap |
|-------------|----------------------|-------------------|-----|
| Workforce (median) | ~$385,000 | $585,800 | **$200K+** |
...
| Metric | Value | Source |
|--------|-------|--------|
| Median household income | **$81,784** | `[1]` |
| Unemployment | ~4–5% (WA state avg.) | `[2]` |
| Poverty rate | ~11–12% | `[2]` |

---

## 6. Homelessness & Social Impact (2024)

| Metric | Value | Source |
|--------|-------|--------|
| Housing Pool — total | **684** (328 unsheltered, 351 sheltered) | `[4]` |
| Emergency shelter PITC | 465 households (↓11% from 2023) | `[4]` |
| K-12 homeless students (2024–25) | **972** | `[4]` |
| Households receiving services | ~1,912 | `[4]` |
| Unsheltered families | +131% since 2020 | `[4]` |

**Self-reported causes of homelessness (2024 PITC):**

| Cause | % Citing | Source |
|-------|---------|--------|
| Housing affordability | **47%** | `[4]` |
| Job loss / unemployment | 37% | `[4]` |
| Mental illness | 28% | `[4]` |
| Family rejection / kicked out | 24% | `[4]` |
| Physical health / disability | 22% | `[4]` |
| Alcohol / substance use | 22% | `[4]` |
| Domestic violence | 20% | `[4]` |
| Eviction | 19% | `[4]` |

> **69%** of homeless individuals lost housing *in* Whatcom County — the crisis is local, not imported.
...
| Entity | Role |
|--------|------|
| **Kulshan Community Land Trust** | Primary MCF pilot partner — LaFreniere Court, Thornton Road, Telegraph Townhomes |
| **Opportunity Council** | Housing and social services |
| **Habitat for Humanity** | Affordable homeownership |
| **Mercy Housing** | Multi-family affordable rental |
| **FHO (Foundation Housing Partners)** | Affordable housing development |

---

## 8. The Affordability Gap

**$200,000+** separates what Whatcom County's workforce can afford from the median home price. 50%+ of renters are cost-burdened. This is structural, not cyclical — population growth + constrained supply + near-zero vacancy.

The "missing middle" — duplexes, triplexes, townhomes, cottage courts, ADUs — is critically undersupplied. Kulshan CLT targets exactly this product type with permanently affordable homeownership.

---

## 9. MCF Intervention Thesis

**Why Whatcom County is the primary MCF pilot target:**

1. **Demand is structural** — 4.2% population growth, near-zero vacancy, $200K+ affordability gap
2. **Crisis is locally generated** — 69% lost housing in-county; intervention dollars stay local
3. **Proven local partner** — Kulshan CLT has LaFreniere Court, Thornton Road, Telegraph Townhomes in pipeline
4. **Faith-aligned impact is measurable** — 972 homeless students; 47% cite affordability as cause
5. **CDFI-aligned** — CLT model is textbook CDFI target: permanently affordable, community-controlled, high-impact
...
| # | Source | URL |
|---|--------|-----|
| `[1]` | Census QuickFacts — Whatcom County, WA | https://www.census.gov/quickfacts/fact/table/whatcomcountywashington/PST045224 |
| `[2]` | Data USA — Whatcom County, WA | https://datausa.io/profile/geo/whatcom-county-wa |
| `[3]` | Whatcom Housing Alliance — Workforce Housing Report (2022) | https://whatcomhousingalliance.org/...Workforce-Housing-Report-Updated-March-2022.pdf |
| `[4]` | Whatcom County — 2024 Homelessness Report | https://www.whatcomcounty.us/DocumentCenter/View/87106/2024-homelessness-report |

---

**Status:** Active — Primary MCF pilot county
**Partner:** Kulshan Community Land Trust
**Pilot projects:** LaFreniere Court | Thornton Road | Telegraph Townhomes