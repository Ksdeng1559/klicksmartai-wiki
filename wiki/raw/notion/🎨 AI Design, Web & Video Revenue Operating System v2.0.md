---
title: "🎨 AI Design, Web & Video Revenue Operating System v2.0"
created: 2026-09-07
updated: 2026-09-07
type: process
status: active
source: notion
notion_id: 3a29e94cf0a4815180aad12b4a92c666
notion_url: https://app.notion.com/p/3a29e94cf0a4815180aad12b4a92c666?pvs=204
tags: [sop, notion-mirror]
sources: [notion: 🎨 AI Design, Web & Video Revenue Operating System v2.0]
---

# 🎨 AI Design, Web & Video Revenue Operating System v2.0

> Mirrored from Notion page `3a29e94cf0a4815180aad12b4a92c666` on 2026-09-07. Source: https://app.notion.com/p/3a29e94cf0a4815180aad12b4a92c666?pvs=204
...
```mermaid
flowchart LR
    A["Business and market signals"] --> B["Audience, account and opportunity intelligence"]
    B --> C["Offer, proof and approved message"]
    C --> D["Creative brief and production"]
    D --> E["Video, web or visual artifact"]
    E --> F["Multichannel distribution"]
    F --> G["Engagement and conversion events"]
    G --> H["CRM scoring and next best action"]
    H --> I["Meeting, application, sale and revenue attribution"]
    I --> C
```
...
Cinematic web-design workflows and reusable design skills
Landing pages, GSAP, WebGL, interaction extraction, reference-video analysis, full-page capture
Research, creative direction, motion specification

[nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill)
UI/UX design intelligence and design-system generation
Product-specific palettes, typography, layouts, UX rules, dashboards, websites and apps
Design-system planning and UX guardrails

[Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill)
Anti-generic visual taste and frontend art direction
Stronger hierarchy, typography, spacing, layout variation and controlled motion
Art direction and quality improvement

[thevangelist/dembrandt](https://github.com/thevangelist/dembrandt)
Website design-system extraction
Extract colors, typography, spacing, components, motion and design tokens from permitted reference sites
Reference analysis and token creation

[21st-dev/magic-mcp](https://github.com/21st-dev/magic-mcp)
Frontend component generation through MCP
Generate and refine production-ready interface components inside coding agents
UI implementation acceleration

[calesthio/OpenMontage](https://github.com/calesthio/OpenMontage)
Agentic video-production operating system
Research, scripting, storyboarding, asset generation, voice, editing, checkpoints and rendering
...
Specialist creative and production agents
UI designer, UX researcher, UX architect, brand guardian, visual storyteller, image prompt engineer and QA roles

[vercel-labs/skills](https://github.com/vercel-labs/skills)
Portable skill installer and skill-management layer
Installing, maintaining and distributing agent skills across coding environments

[alibaba/page-agent](https://github.com/alibaba/page-agent)
Natural-language control of web interfaces
Agent-driven page interaction, embedded website assistants and browser-style UI actions

[remotion-dev/remotion](https://github.com/remotion-dev/remotion)
Code-based video rendering
Programmatic compositions, timelines, captions, animations and final MP4 rendering

[shadcn-ui/ui](https://github.com/shadcn-ui/ui)
Reusable accessible UI component foundation
Dashboards, SaaS applications, CRM interfaces and consistent frontend systems

[21st-dev/agent-elements](https://github.com/21st-dev/agent-elements)
Components for agentic interfaces
AI chat, tool activity, agent state and AI-native application interfaces
...
[Aura Build](https://www.aura.build/browse/components)
Component and visual-pattern references

[Mobbin](https://mobbin.com/)
Proven mobile and web product-flow research

[21st.dev](https://21st.dev/)
Community UI component references

[Hallmark](https://www.usehallmark.com/)
Brand and design workflow reference
...
UI UX Pro Max → Taste Skill → Magic MCP → verification
Dembrandt, shadcn/ui
Responsive production website

Premium cinematic website
MengTo reference workflow → UI UX Pro Max → Taste Skill → GSAP/Three.js skills → implementation → performance audit
Dembrandt, Magic MCP
High-end interactive landing experience

SaaS dashboard or CRM
UI UX Pro Max → shadcn/ui → Magic MCP → accessibility and responsive QA
Taste Skill at moderate density
Production dashboard and component library

Website redesign from a reference
Authorized Dembrandt extraction → stitched capture → UI UX Pro Max synthesis → Taste Skill → implementation
HTML-to-interaction prompts
Original redesign using extracted principles

Landing page from a video reference
Video-to-superprompt → UI UX Pro Max → Taste Skill → landing-page/GSAP skills → implementation
Magic MCP
Recreated interaction language with original branding

Social visual or banner
Brand brief → UI UX Pro Max banner/design-system skill → image prompt engineer → visual QA
Taste Skill
Campaign visual in required aspect ratios

Product explainer video
Research → OpenMontage script/storyboard → asset and voice generation → Remotion render → QA
MengTo ElevenLabs and browser-recording skills
Branded explainer video

Website demo video
Browser recording → scripted cursor and page states → voiceover → captions → Remotion/OpenMontage
OpenMontage stock and music providers
Product walkthrough video

AI-generated campaign video
Brand strategy → visual storyteller → OpenMontage pipeline → image/video models → edit/render
Taste-driven image references
Multi-format campaign creative
...
Creative Director
Owns concept, references and visual coherence
Approved creative direction

UX Strategist
Aligns user journey and conversion
Page flow and UX requirements

Brand Guardian
Enforces brand consistency
Brand approval or correction list

Design-System Architect
Creates tokens and component rules
`DESIGN.md` and tokens

UI Designer
Produces layouts and component compositions
Approved visual frames
...
Motion Designer
Defines purposeful motion
Motion specification

Visual Storyteller
Converts messages into imagery and sequences
Storyboard or visual narrative

Video Producer
Runs the OpenMontage pipeline
Render-ready project

QA and Performance Reviewer
Tests accessibility, responsiveness and performance
Pass/fail report
...
OpenMontage
Research, script, storyboard, asset selection, voice, approval stages and delivery coordination

HTML-native motion production
HyperFrames
Turns HTML, CSS, media and seekable animation into deterministic MP4 video

React-native programmable rendering
Remotion
Builds complex React compositions, reusable timelines, data-driven scenes and multi-format renders

Generative visual assets
Image and video models
Creates footage, backgrounds, avatars, illustrations and scene assets used by the renderer
...
Fast branded product intro
Brief → storyboard → HyperFrames → audio/captions → QA

Typography-led social video
Brand tokens → copy → HyperFrames → aspect-ratio adaptations

Animated website or UI explainer
Screen/UI assets → HyperFrames → voiceover → captions → QA

Complex data-driven video
OpenMontage → Remotion → reusable data compositions → render

Mixed generative campaign video
OpenMontage → generated assets → HyperFrames/Remotion → final assembly

Avatar-led explainer
OpenMontage script → HeyGen avatar → HyperFrames overlays → final render
...
Scrapling
Acquire page content and structured public-web data at page or crawl scale

Dembrandt
Extract visual design systems, tokens, typography, spacing and interaction patterns

MengTo capture skills
Capture screenshots, recordings and interaction references for creative recreation

Parallel, Exa and Serper
Discover and rank relevant sources across the web

DataForSEO
Provide structured search, keyword, SERP and SEO data

Open Design
Turn approved research and design direction into visual creative work
...
Short-form video advertisement
Offer and audience → proof → hook → script → storyboard → B-roll/avatar → deterministic overlays → verification
OpenMontage, HeyGen or footage model, Remotion, QA
Attention, click or conversion

Personalized B2B sales video
Signal and CRM context → personalized script → adviser or avatar opening → exact account facts → branded prospect page → tracked delivery
Convex, recording or avatar provider, Remotion, Unipile, n8n
Reply, meeting or opportunity advancement

Product demonstration
User problem → scripted product states → screen recording → narration → captions → CTA
Browser recording, OpenMontage, voice, Remotion
Understanding, activation or demo request

Data or financial explainer
Verified dataset → interpretation → deterministic charts and calculations → narration → disclosure review
Convex or source data, Remotion, human review
Education and decision support

Founder or expert video
Point of view → approved proof → presenter-led opening → supporting scenes → CTA
Human recording or HeyGen, OpenMontage, Remotion
Trust and authority

Database-reactivation campaign
CRM segmentation → message variant → personalized render → multichannel delivery → engagement scoring
Convex, n8n, video provider, Unipile or SMS
