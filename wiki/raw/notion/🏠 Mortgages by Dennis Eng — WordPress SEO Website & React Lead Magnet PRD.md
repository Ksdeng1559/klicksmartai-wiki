---
title: "🏠 Mortgages by Dennis Eng — WordPress SEO Website & React Lead Magnet PRD"
created: 2026-09-07
updated: 2026-09-07
type: process
status: active
source: notion
notion_id: 3a49e94cf0a48191a554e67a3343d08f
notion_url: https://app.notion.com/p/3a49e94cf0a48191a554e67a3343d08f?pvs=204
tags: [sop, notion-mirror]
sources: [notion: 🏠 Mortgages by Dennis Eng — WordPress SEO Website & React Lead Magnet PRD]
---

# 🏠 Mortgages by Dennis Eng — WordPress SEO Website & React Lead Magnet PRD

> Mirrored from Notion page `3a49e94cf0a48191a554e67a3343d08f` on 2026-09-07. Source: https://app.notion.com/p/3a49e94cf0a48191a554e67a3343d08f?pvs=204
...
WordPress
CMS, editorial workflow, media, users and publishing

Gutenberg
Visual content editing and reusable page sections

Custom block theme
Brand design, templates, responsive layout and performance
...
React
Interactive calculator and assessment interfaces

TypeScript
Form types, mortgage logic, validation and API contracts

Supabase
Lead records, calculator events and result persistence

Atomic CRM
Advisor pipeline and lead management

n8n
Routing, notifications, enrichment and follow-up automation
...
Ship one content cluster and one assessment first

AI-generated factual errors
Require primary sources and broker review

Mortgage calculation errors
Unit tests, scenario tests and professional review

Elementor remnants
Dependency inventory and staged migration

Plugin conflicts
Minimal plugin set and staging validation

Lead-data exposure
Data minimization, secure transport and access controls

Search-quality risk from scaled content
Original expertise, useful tools, evidence and editorial QA

Uncontrolled Claude Code changes
Git branches, code review, backups and scoped prompts
