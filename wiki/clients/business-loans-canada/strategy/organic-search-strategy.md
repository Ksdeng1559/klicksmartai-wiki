...
- `~/wiki/.local_tier/runs/tariff-loan-batch/consolidated_keyword_set.json` — 124 terms, 10 play groups
- `~/wiki/.local_tier/runs/tariff-loan-batch/KEYWORD_STRATEGY.md` — Strategist's play-group plan
- `~/wiki/.local_tier/runs/tariff-loan-batch/REPORT.md` — original data pull report
